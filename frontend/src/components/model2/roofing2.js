...
const Roofing2 = () => {
  const data = [
    { name: "Rib Type 5mm", price: 32000 },
    { name: "Trusses Tubular Steel", price: 15000 },
    { name: "Labor", price: 45000 },
  ...
  return (
    ...
    <div style={{ textAlign: "center" }}>
      ...
      <a className="ed-button" type="button" href="painting"> Painting Works</a>
    </div>
    </div>
  );
};

export default Roofing2;